...
A ready made checkout flow for [Vendr](http://vendr.net) , the eCommerce solution for [Umbraco](https://umbraco.com)

![Screenshot](assets/002.png)

## About

Vendr Checkout is an add-on package for Vendr, the Umbraco eCommerce solution, providing a drop-in checkout flow solution.
...
* .NET 4.7.2 SDK or newer / .NET 5.0 SDK or newer
* Umbraco 8.10.3 or newer / Umbraco 9.0.0 or newer
* Vendr 2.0.0 or newer
...
Copyright © 2021 Outfield Digital Ltd
